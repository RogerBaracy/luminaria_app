const data = [
  ...
  },
  {
    ...
    content: ['quasar create &lt;folder_name&gt;']
  },
  {
    ancora: 'dotenv',
  ...
  },
  {
    ...
    content: [
      'Para a aplicação web se conectar ao banco de dados precisamos ter o pacote do Firebase instalado no projeto, para isso executamos o comando:',
      'npm install firebase <br> ou <br> yarm add firebase'
    ]
  },
  {
    ancora: 'config_env',
